...
const Home: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Building reliable, scalable cloud infrastructure and DevOps pipelines that keep your products running smoothly.",
  ...
  const faqs = [
    {
      ...
      answer: "We provide end-to-end product design and development services, including brand strategy, UI/UX design, web and mobile development, and product infrastructure."
    },
    {
      question: "Do you work with startups?",
      answer: "Yes, we love working with startups. We provide a flexible and fast-paced environment to help you move quickly and build things the right way."
    },
    {
      question: "Is your pricing transparent?",
      answer: "Absolutely. We provide clear, upfront pricing based on the scope of your project. No hidden fees, no surprises."
    },
    {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-24 reveal">
            ...
            <h1 className="text-4xl md:text-[40px] font-medium tracking-tight leading-[1.1] max-w-4xl">
              <span className="text-neutral-400">Design, develop, and scale products</span> with speed and strong foundations for  companies that want to move fast and build properly.
            </h1>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-end items-end gap-12 reveal stagger-1 mb-20">
            <div className="max-w-md">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <Button to="/works" variant="secondary" className="bg-[#F5F5F5] text-neutral-900 px-8 py-4 rounded-lg font-bold hover:bg-neutral-200 transition-all text-sm uppercase tracking-wider whitespace-nowrap">
                  See recent work
                </Button>
              </div>
            </div>
        ...
        <div className="flex whitespace-nowrap animate-marquee hover:[animation-play-state:paused]">
          {[1, 2].map((group) => (
            <div key={group} className="flex space-x-6 px-3">
              <div className="w-[500px] aspect-[16/10] rounded-lg overflow-hidden bg-neutral-100 flex-shrink-0">
                <img src="/images/carefusion.png" className="w-full h-full object-cover" alt="Product" />
              </div>
              <div className="w-[600px] aspect-[16/10] rounded-lg overflow-hidden bg-neutral-100 flex-shrink-0">
      ...
      <section className="bg-black py-32 px-6" id="works">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <span className="text-[10px] font-bold text-neutral-500 uppercase tracking-[0.3em] mb-4 block">WHAT WE HAVE BUILT</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-[#1A1A1A] p-12 rounded-lg flex flex-col justify-between group reveal">
              ...
              <div>
                ...
                <Link to="/works" className="text-[10px] font-bold text-white uppercase tracking-[0.2em] flex items-center group-hover:text-primary transition-colors">
            ...
            <div className="bg-white p-12 rounded-lg min-h-[320px] flex flex-col justify-between group reveal stagger-1">
              ...
              <div>
                ...
                <Link to="/products" className="text-[10px] font-bold text-black uppercase tracking-[0.2em] flex items-center group-hover:text-primary transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-[#1A1A1A] rounded-lg overflow-hidden flex flex-col md:flex-row reveal">
              ...
              <div className="flex-1 bg-[#0E9D44] p-12 flex flex-col justify-between">
                <div>
                  <h3 className="text-4xl font-bold text-white mb-6 leading-tight">Jotta<br />Note</h3>
                ...
                <Link to="/works" className="text-[10px] font-bold text-white uppercase tracking-[0.2em] flex items-center mt-12 hover:underline underline-offset-8">
            ...
            <div className="bg-[#1A1A1A] p-12 rounded-lg flex flex-col justify-between group reveal stagger-2">
              <div>
                <span className="text-[10px] font-bold text-orange-700 uppercase tracking-[0.2em] mb-4 block">NEXT IN LINE</span>
              ...
              <div>
                <div className="w-full h-[1px] bg-neutral-800 mb-8"></div>
                <Link to="/contact" className="text-[10px] font-bold text-white uppercase tracking-[0.2em] flex items-center group-hover:text-primary transition-colors">
      ...
      <section className="py-32 px-6 bg-[#FAFAFA]" id="services">
        <div className="max-w-7xl mx-auto">
          <div className="mb-24 reveal">
            <span className="text-[10px] font-bold text-[#E25C3D] uppercase tracking-[0.3em] mb-4 block">CAPABILITIES</span>
            <h2 className="text-5xl md:text-6xl font-bold text-neutral-900 tracking-tight max-w-4xl">Strategy, design, and code all under one roof.</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {services.map((service, i) => (
              <div key={i} className={`p-12 bg-white flex flex-col justify-between min-h-[400px] rounded-lg reveal stagger-${(i % 4) + 1}`}>
                <div>
      ...
      <section className="py-32 px-6 border-t border-neutral-100 bg-[#FAFAFA]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-32 gap-6">
            ...
            <Link to="/about" className="px-6 py-3 bg-[#F0F0F0] text-neutral-900 rounded-lg text-sm font-medium hover:bg-neutral-200 transition-colors">
          ...
          <div className="space-y-16 mb-40">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start border-t border-neutral-100 pt-10">
              ...
              <div className="lg:col-span-8 text-2xl font-bold text-neutral-800 leading-snug">
                We believe that the best products are built at the intersection of rigorous engineering and intuitive human design.
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start border-t border-neutral-100 pt-10">
              <div className="lg:col-span-4 text-[11px] font-bold text-neutral-500 uppercase tracking-[0.2em] font-mono leading-relaxed">
                A SIMPLE PHILOSOPHY:<br />ENGINEERING PRECISION
              </div>
              <div className="lg:col-span-8 text-xl text-neutral-600 leading-relaxed">
                We avoid the arbitrary. Every line of code and every design decision is measured against its impact on performance and user clarity. At HyperlandHQ, we don't just build features; we build technical foundations that scale as fast as your ambition.
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-10 rounded-xl flex items-start reveal stagger-1 shadow-none">
              <p className="text-sm text-neutral-500 leading-relaxed font-light">
                With 8+ years of experience and over 100 projects led, Kwesi has partnered with founders, CTOs, and CXOs to shape strategy and drive results.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-xl flex items-start reveal stagger-3 shadow-none">
              <p className="text-sm text-neutral-500 leading-relaxed font-light">
                Pearl is the heart of HyperlandHQ's creative direction. A true art director, she brings humanity, depth, and vision to every project she touches.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 px-6 bg-neutral-50">
        <div className="max-w-3xl mx-auto text-center mb-20">
          <h2 className="text-xl font-bold text-neutral-900 mb-4">Things founders usually ask before starting working together</h2>
        </div>
        <div className="max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, i) => (
            <div key={i} className={`bg-white rounded-xl border border-neutral-100 overflow-hidden reveal stagger-${(i % 4) + 1}`}>
              <button
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <div className="flex items-start space-x-4 mb-12 border-l-2 border-[#0E9D44] pl-6 py-2">
                <p className="text-neutral-300 text-lg">
                  They are built by teams that care about every detail.
                </p>
              </div>
              <Button to="/works" className="bg-[#0E9D44] text-white px-8 py-4 rounded-md font-bold hover:bg-[#0c8a3c] transition-all inline-flex items-center space-x-3">
